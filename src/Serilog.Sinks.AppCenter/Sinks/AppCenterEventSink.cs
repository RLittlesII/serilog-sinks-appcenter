...
{
    /// <summary>
    /// Serilog sink for App Center <see cref="Analytics"/>.
    /// </summary>
    /// <seealso cref="Serilog.Sinks.AppCenter.AppCenterSink" />
    public class AppCenterEventSink : AppCenterSink
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AppCenterEventSink"/> class.
        /// </summary>
        /// <param name="formatProvider">The format provider.</param>
        /// <param name="appSecret">The application secret.</param>
        /// <param name="properties">The properties.</param>
        /// <param name="restrictedToMinimumLevel">The restricted to minimum level.</param>
        public AppCenterEventSink(
        ...
        public override void Emit(LogEvent logEvent)
        {
            ...
            Analytics.TrackEvent(logEvent.RenderMessage(), Properties);
        }
    }
}
